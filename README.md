...
[![Release](https://img.shields.io/badge/Release-v2.0.0-10B981)](https://github.com/Blackswan-Yazilim/video-downloader/releases)
...
Download the latest `VideoDownloader-2.0.0-Setup.msi` installer from the [Releases](https://github.com/Blackswan-Yazilim/video-downloader/releases/tag/v2.0.0) page and run the setup wizard.
